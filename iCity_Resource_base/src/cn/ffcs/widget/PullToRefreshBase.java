...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	public void setFootReleaseLabel(String releaseLabel) {
		if (null != footerLayout) {
			footerLayout.setReleaseLabel(releaseLabel);
		}
	}
	
	public void setFootPullLabel(String pullLabel) {
		if (null != footerLayout) {
			footerLayout.setPullLabel(pullLabel);
		}
	}

	public void setFootRefreshingLabel(String refreshingLabel) {
		if (null != footerLayout) {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		// Styleables from XML
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.news_pullToRefresh);
		if (a.hasValue(R.styleable.news_pullToRefresh_mode)) {
			mode = a.getInteger(R.styleable.news_pullToRefresh_mode, MODE_PULL_DOWN_TO_REFRESH);
		}
		...
		// Styleables from XML
		if (a.hasValue(R.styleable.news_pullToRefresh_headerTextColor)) {
			final int color = a.getColor(R.styleable.news_pullToRefresh_headerTextColor, Color.BLACK);
			if (null != headerLayout) {
		...
		if (a.hasValue(R.styleable.news_pullToRefresh_headerBackground)) {
			if(headerLayout!=null){
				headerLayout.setBackground(a.getResourceId(R.styleable.news_pullToRefresh_headerBackground, Color.WHITE));
			}
			if(footerLayout!=null){
				footerLayout.setBackground(a.getResourceId(R.styleable.news_pullToRefresh_headerBackground, Color.WHITE));
			}
		}
		if (a.hasValue(R.styleable.news_pullToRefresh_adapterViewBackground)) {
			refreshableView.setBackgroundResource(a.getResourceId(R.styleable.news_pullToRefresh_adapterViewBackground,
					Color.WHITE));
		}
		a.recycle();
