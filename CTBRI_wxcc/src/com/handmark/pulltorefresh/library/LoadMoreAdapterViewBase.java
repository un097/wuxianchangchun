...
public abstract class LoadMoreAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
		OnScrollListener {
//	private final static boolean DEBUG = false;
//	private final static String LOG_TAG = "LOADMORE_VIEW";
	...
	public LoadMoreAdapterViewBase(Context context) {
		super(context);
		mRefreshableView.setOnScrollListener(this);
	}

	public LoadMoreAdapterViewBase(Context context, AttributeSet attrs) {
		super(context, attrs);
		mRefreshableView.setOnScrollListener(this);
	}

	public LoadMoreAdapterViewBase(Context context, Mode mode) {
		super(context, mode);
		mRefreshableView.setOnScrollListener(this);
	}

	public LoadMoreAdapterViewBase(Context context, Mode mode, AnimationStyle animStyle) {
...
//		if (null == adapter || adapter.isEmpty()) 
		//2014年11月3号修改， 删除  adapter.isEmpty() 的条件判断。当adapter.isEmpty() 返回true时，如果此时设置了
		// ListView 的 header ，在下拉时。会吃掉 header 的上半部分。
		if (null == adapter ) 
		{
			if (DEBUG) {
