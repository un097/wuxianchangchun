...
public class CommonTaskJsonNew extends BaseTask<Void, Void, Void> {
	...
	public CommonTaskJsonNew(HttpCallBack iCall, Context context) {
		super(iCall, context);
	}

	public static CommonTaskJsonNew newInstance(HttpCallBack iCall, Context context,
			Class<?> toJsonObjectClass) {
		return new CommonTaskJsonNew(iCall, context, toJsonObjectClass);
	}

	private CommonTaskJsonNew(HttpCallBack iCall, Context context, Class<?> clazz) {
		super(iCall, context);
		this.clazz = clazz;
	}

	private CommonTaskJsonNew(HttpCallBack iCall, Class<?> clazz) {
		super(iCall);
		this.clazz = clazz;
	}
