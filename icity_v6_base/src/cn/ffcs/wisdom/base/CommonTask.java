...
public class CommonTask extends BaseTask<Void, Void, Void> {
	 ...
	 * @return
	 */
	public static CommonTask newInstance(HttpCallBack iCall, Context context,
			Class<?> toJsonObjectClass) {
		return new CommonTask(iCall, context, toJsonObjectClass);
	}
	 ...
	 * @return
	 */
//	public static CommonTask newInstance(HttpCallBack iCall, Class<?> toJsonObjectClass) {
//		return new CommonTask(iCall, toJsonObjectClass);
//	}

	private CommonTask(HttpCallBack iCall, Context context, Class<?> clazz) {
		super(iCall, context);
		this.clazz = clazz;
	}

	private CommonTask(HttpCallBack iCall, Class<?> clazz) {
		super(iCall);
		this.clazz = clazz;
	}
	...
	public void setRequsetMethod(String method) {
		this.method = method;
	}
	...
	protected BaseResp doInBackground(Void... parameters) {
		...
		HttpRequest request = new HttpRequest(method, BaseResp.class);
