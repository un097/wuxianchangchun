 ...
 * <p>Update Comments:                 </p>
 */
public class GloImageLoader2 extends BaseImageLoader {
	private Bitmap defaultFailLoading;

	public GloImageLoader2(Context context) {
		super(context);
		defaultFailLoading = bitMap.get(R.drawable.glo_loading_image);
		if (defaultFailLoading == null) {
			defaultFailLoading = BitmapFactory.decodeResource(context.getResources(),
					R.drawable.glo_loading_image);
			bitMap.put(R.drawable.glo_loading_image, defaultFailLoading);
		}
	}
