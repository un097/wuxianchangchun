...
public class BottomAlbumAdapter extends BaseAdapter {
	...
	public BottomAlbumAdapter(Context context, PhotoAibum aibum,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		BottomPhotoGridItem item;
		if (convertView == null) {
			item = new BottomPhotoGridItem(context);
			item.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
					LayoutParams.MATCH_PARENT));
		} else {
			item = (BottomPhotoGridItem) convertView;
		}
		// 通过ID 加载缩略图
		if (gl_arr == null) {
