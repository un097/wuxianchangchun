...
public class CommonStandardTask extends BaseTask<Void, Void, Void> {
	...
	public CommonStandardTask(HttpCallBack iCall, Context context) {
		super(iCall, context);
	}

	public static CommonStandardTask newInstance(HttpCallBack iCall, Context context,
			Class<?> toJsonObjectClass) {
		return new CommonStandardTask(iCall, context, toJsonObjectClass);
	}

	private CommonStandardTask(HttpCallBack iCall, Context context, Class<?> clazz) {
		super(iCall, context);
		this.clazz = clazz;
	}

	private CommonStandardTask(HttpCallBack iCall, Class<?> clazz) {
		super(iCall);
		this.clazz = clazz;
	}
