...
public class BottomPhotoGridItem extends RelativeLayout implements Checkable {
	private Context mContext;
	private boolean mCheck;
	private ImageView mImageView;
	private ImageView mSelect;
	
	public BottomPhotoGridItem(Context context) {
		this(context, null, 0);
	}
	
	public BottomPhotoGridItem(Context context, AttributeSet attrs) {  
        this(context, attrs, 0);  
    }

	public BottomPhotoGridItem(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		mContext = context;
		LayoutInflater.from(mContext).inflate(R.layout.item_bottom_photo_album, this);
