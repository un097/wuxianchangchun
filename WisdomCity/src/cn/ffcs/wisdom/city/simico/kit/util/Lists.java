 ...
 * 
 * <p>
 * NOTE: this is a copy of a subset of Guava's
...
public final class Lists {
	 ...
	 *            the exact size of the initial backing array for the returned
	 *            array list ({@code ArrayList} documentation calls this value
	 *            the "capacity")
	 ...
	 *             if {@code initialArraySize} is negative
	 */
	...
	/**
	 * Returns a new mutable {@code ArrayList} instance containing the given
	 * elements.
	 * 
	 * @param elements
